...
app.use('/', express.static('Resources/js/file-bundle/test/server'))
app.use('/media/', express.static('Resources/js/file-bundle/test/server/media'))
app.use('/assets/', express.static('Resources/js/file-bundle/test/server/build/assets'))
