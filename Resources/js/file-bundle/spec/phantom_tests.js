...
function check(conf) {
  var id = conf.id;
  var page = conf.page;
  var _onError = conf.onError;
  var _onReady = conf.onReady;
  ...
  (0, _util.waitFor)({
    onTest: function onTest() {
      data = page.evaluate(function () {
        var form = document.querySelector('div.form-inline.pull-right');
        var s = document.querySelector('button[type=button] > span.fa.fa-circle-o-notch.fa-spin');
        if (form !== null && s === null) {
          return {
  ...
  (0, _util.waitFor)({
    onTest: function onTest() {
      var data = page.evaluate(function () {
        ...
        var s = document.querySelectorAll('button[type=button] > span.text-label');
        var clicked = false;
        if (s) {
          Array.from(s).forEach(function (span) {
  ...
  (0, _util.waitFor)({
    onTest: function onTest() {
      var data = page.evaluate(function (n) {
        // get the input field
        var input = document.querySelector('input[placeholder=Mapnaam]');
        if (input !== null) {
          input.value = n;
          return {
            ready: true
    ...
    onError: function onError(error) {
      _onError3({ id: id, error: error });
    }
  });
}

function createFolder(conf) {
  var id = conf.id;
  var page = conf.page;
  var _onError4 = conf.onError;
  ...
  (0, _util.waitFor)({
    ...
    onError: function onError(error) {
      _onError4({ id: id, error: error });
    }
  });
}
exports.default = createFolder;

},{"./util":304}],299:[function(require,module,exports){
(function (global){
'use strict';
...
var _task_runner2 = _interopRequireDefault(_task_runner);

var _open_page = require('./open_page');

var _open_page2 = _interopRequireDefault(_open_page);

var _open_folder = require('./open_folder');

var _open_folder2 = _interopRequireDefault(_open_folder);

var _upload_file = require('./upload_file');

var _upload_file2 = _interopRequireDefault(_upload_file);

var _create_folder = require('./create_folder');

var _create_folder2 = _interopRequireDefault(_create_folder);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_fs2.default.removeTree('./spec/screenshots');

// every time we run the jasmine suite we remove all screenshots made by
// previous test runs

_fs2.default.makeDirectory('./spec/screenshots');
...
var testResults = [];
var taskRunner = new _task_runner2.default();
var debug = false;
...
},{"./create_folder":298,"./open_folder":300,"./open_page":301,"./task_runner":302,"./upload_file":303,"babel-polyfill":1,"fs":undefined,"webpage":undefined}],300:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.checkIfLoaded = undefined;
  ...
  (0, _util.waitFor)({
    onTest: function onTest() {
      data = page.evaluate(function (folderName) {
        var folderNames = document.querySelectorAll('tr.folder > td.name');
        if (typeof folderNames === 'undefined') {
          return { loaded: false };
        }
        var loaded = true;
        //let names = []
        Array.from(folderNames).forEach(function (n) {
    ...
    onReady: function onReady() {
      ...
      _onReady(_extends({ id: id, name: name }, data));
    },
    onError: function onError(error) {
      _onError({ id: id, error: error });
    }
 ...
 *                                  returns false or reaches the timeout.
 */
exports.checkIfLoaded = checkIfLoaded;
function openFolder(conf) {
  ...
  (0, _util.waitFor)({
    ...
    onReady: function onReady() {
      ...
      checkIfLoaded(_extends({}, conf, data));
    },
    onError: function onError(error) {
      _onError2({ id: id, error: error });
    }
...
},{"./util":304}],301:[function(require,module,exports){
'use strict';
...
function openPage(conf) {
  ...
  page.open(url, function (status) {
    if (status !== 'success') {
      _onError({ id: id, error: 'cannot open page ' + url });
      return;
    }
    var data = void 0;
    (0, _util.waitFor)({
      ...
      onReady: function onReady() {
        ...
        _onReady({ id: id, title: data.title });
      },
      onError: function onError(error) {
        _onError({ id: id, error: error });
      }
...
},{"./util":304,"system":undefined}],302:[function(require,module,exports){
"use strict";
...
var TaskRunner = function () {
  ...
  _createClass(TaskRunner, [{
    ...
    value: function configure(conf) {
      ...
      var onReady = conf.onReady;
      var _conf$startIndex = conf.startIndex;
      var startIndex = _conf$startIndex === undefined ? 0 : _conf$startIndex;
      var _conf$maxIndex = conf.maxIndex;
      var maxIndex = _conf$maxIndex === undefined ? tasks.length : _conf$maxIndex;
      var _conf$debug = conf.debug;
      var debug = _conf$debug === undefined ? false : _conf$debug;

      Object.assign(this, { tasks: tasks, onReady: onReady, startIndex: startIndex, maxIndex: maxIndex, debug: debug });
      return this;
    }
    ...
    key: "runTask",
    value: function runTask(extraArgs) {
      this.taskIndex++;
      if (this.taskIndex < this.maxIndex) {
        ...
        task.func(_extends({ id: task.id }, task.args, extraArgs));
      } else {
        this.onReady();
      }
    }
...
function checkIfUploaded(conf) {
  ...
  (0, _util.waitFor)({
    ...
    onReady: function onReady() {
      ...
      _onReady(_extends({ id: id, uploaded: true, multiple: multiple }, data));
    },
    onError: function onError(error) {
      _onError({ id: id, error: error });
    }
  ...
  (0, _util.waitFor)({
    onTest: function onTest() {
      var loaded = page.evaluate(function () {
        var u = document.querySelectorAll('input[type=file]');
...
},{"./util":304}],304:[function(require,module,exports){
(function (global){
'use strict';
 ...
 */
function waitFor(conf) {
  var _conf$timeout = conf.timeout;
  var timeout = _conf$timeout === undefined ? 10000 : _conf$timeout;
  var _conf$delay = conf.delay;
  var delay = _conf$delay === undefined ? 50 : _conf$delay;
  var onTest = conf.onTest;
  var _conf$onTestArgs = conf.onTestArgs;
  var onTestArgs = _conf$onTestArgs === undefined ? {} : _conf$onTestArgs;
  var _conf$onCheck = conf.onCheck;
  var onCheck = _conf$onCheck === undefined ? function () {} : _conf$onCheck;
  var _conf$onReady = conf.onReady;
  var onReady = _conf$onReady === undefined ? function () {} : _conf$onReady;
  var _conf$onError = conf.onError;
  var onError = _conf$onError === undefined ? null : _conf$onError;
 ...
 */
var chainPromises = exports.chainPromises = function chainPromises(conf) {
  var _conf$index = conf.index;
  var index = _conf$index === undefined ? 0 : _conf$index;
  var _conf$promises = conf.promises;
  var promises = _conf$promises === undefined ? [] : _conf$promises;
  var _conf$resolve = conf.resolve;
  var resolve = _conf$resolve === undefined ? function () {} : _conf$resolve;
  var _conf$reject = conf.reject;
  var reject = _conf$reject === undefined ? function () {} : _conf$reject;
  var _conf$values = conf.values;
  var values = _conf$values === undefined ? [] : _conf$values;
  var _conf$errors = conf.errors;
  var errors = _conf$errors === undefined ? [] : _conf$errors;
  var _promises$index = promises[index];
  var id = _promises$index.id;
  var func = _promises$index.func;
  var _promises$index$args = _promises$index.args;
  var args = _promises$index$args === undefined ? [] : _promises$index$args;
  var parseRejectValue = _promises$index.parseRejectValue;
  var parseResolveValue = _promises$index.parseResolveValue;
  ...
  if (typeof func !== 'function') {
    ...
    index++;
    chainPromises({ index: index, promises: promises, resolve: resolve, reject: reject, values: values, errors: errors });
  }
