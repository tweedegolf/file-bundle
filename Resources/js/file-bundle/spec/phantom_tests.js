...
function printResults() {
  if (debug === true) {
    console.log('\n==== :RESULTS: =====');
    Object.keys(testResults).forEach(function (key, i) {
...
function checkIfLoaded(conf) {
  ...
  (0, _util.waitFor)({
    ...
    onReady: function onReady() {
      ...
      _onReady(_extends({}, data, { id: id, name: name }));
    },
    onError: function onError(error) {
      _onError({ id: id, error: error });
    }
...
function checkIfUploaded(conf) {
  ...
  (0, _util.waitFor)({
    ...
    onReady: function onReady() {
      ...
      _onReady(_extends({ uploaded: true }, data, { id: id, multiple: multiple }));
    },
    onError: function onError(error) {
      _onError({ id: id, error: error });
    }
