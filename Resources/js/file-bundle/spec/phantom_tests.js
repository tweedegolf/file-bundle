...
var _read_folder = require('./read_folder');
...
function printResults() {
  console.log('\n==== :RESULTS: =====');
  testResult.forEach(function (result, i) {
...
var tasks = [{
  ...
  func: _upload_file.checkIfUploaded,
  args: {
    page: page,
    files: ['./spec/media/400x220.png'],
    onError: onError,
...
},{"./open_folder":299,"./open_page":300,"./read_folder":301,"./task_runner":302,"./upload_file":303,"babel-polyfill":1,"fs":undefined,"webpage":undefined}],299:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.openFolder = undefined;
...
function openPage(conf) {
  ...
  for (var i = _system.args.length - 1; i > 0; i--) {
    var arg = _system.args[i];
...
},{"./util":304,"system":undefined}],301:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.readFolder = undefined;
...
function readFolder(conf) {
  ...
  (0, _util.waitFor)({
    ...
    onReady: function onReady() {
      ...
      _onReady(_extends({}, data, { id: id, name: folderName }));
    },
    onError: function onError(error) {
      _onError({ id: id, error: error });
    }
...
},{"./util":304}],302:[function(require,module,exports){
"use strict";
...
var TaskRunner = function () {
  ...
  _createClass(TaskRunner, [{
    key: "configure",
    value: function configure(tasks, onReady, taskIndexes) {
      this.tasks = tasks;
    ...
    value: function runTask(extraArgs) {
      ...
      if (this.taskIndex < this.maxIndex) {
        var index = this.taskIndexes[this.taskIndex];
...
exports.checkIfUploaded = exports.uploadFile = undefined;
...
function checkIfUploaded(conf) {
  ...
  (0, _util.waitFor)({
    ...
    onReady: function onReady() {
      ...
      _onReady2(_extends({ uploaded: true }, data, { id: id, multiple: multiple }));
    },
    onError: function onError(error) {
...
exports.checkIfUploaded = checkIfUploaded;
