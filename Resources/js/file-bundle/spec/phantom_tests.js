...
var tasks = [{
  ...
  args: {
    page: page,
    onError: onError,
    onReady: function onReady(folderName) {
      testResult.openFolder = { folderName: folderName };
      console.log(folderName);
      taskRunner.runTask({ folderName: folderName });
    }
  }
}, {
...
taskRunner.configure(tasks, function () {
  console.log('done');
  phantom.exit(0);
});
...
},{"./open_folder":299,"./open_page":300,"./read_folder":301,"./task_runner":302,"babel-polyfill":1,"fs":undefined,"webpage":undefined}],299:[function(require,module,exports){
'use strict';
...
},{"system":undefined}],301:[function(require,module,exports){
'use strict';
...
},{"./util":303}],302:[function(require,module,exports){
"use strict";
...
var TaskRunner = function () {
  ...
  _createClass(TaskRunner, [{
    key: "configure",
    value: function configure(tasks, onReady) {
      /*
    ...
    value: function runTask(extraArgs) {
      ...
      if (this.taskIndex < this.tasks.length) {
        ...
        task.func(_extends({}, task.args, extraArgs));
      } else {
        this.onReady();
      }
    }
