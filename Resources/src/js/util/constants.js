 ...
 * @type       {string}
 */
export const ITEMS_MOVED: 'ITEMS_MOVED' = 'ITEMS_MOVED';
 ...
 * @type       {string}
 */
export const ERROR_MOVING_ITEMS: 'ERROR_MOVING_ITEMS' = 'ERROR_MOVING_ITEMS';
...
export const CONFIRM_RENAME_FOLDER: 'CONFIRM_RENAME_FOLDER' = 'CONFIRM_RENAME_FOLDER';
...
export const RECYCLE_BIN_ID: 'recycleBin' = 'recycleBin';
export const OPEN_RECYCLE_BIN: 'OPEN_RECYCLE_BIN' = 'OPEN_RECYCLE_BIN';
export const CLOSE_RECYCLE_BIN: 'CLOSE_RECYCLE_BIN' = 'CLOSE_RECYCLE_BIN';
export const RECYCLE_BIN_FROM_CACHE: 'RECYCLE_BIN_FROM_CACHE' = 'RECYCLE_BIN_FROM_CACHE';
export const EMPTY_RECYCLE_BIN: 'EMPTY_RECYCLE_BIN' = 'EMPTY_RECYCLE_BIN';
export const RECYCLE_BIN_EMPTIED: 'RECYCLE_BIN_EMPTIED' = 'RECYCLE_BIN_EMPTIED';
export const ERROR_EMPTY_RECYCLE_BIN: 'ERROR_EMPTY_RECYCLE_BIN' = 'ERROR_EMPTY_RECYCLE_BIN';
export const RECYCLE_BIN_OPENED: 'RECYCLE_BIN_OPENED' = 'RECYCLE_BIN_OPENED';
export const ERROR_OPENING_RECYCLE_BIN: 'ERROR_OPENING_RECYCLE_BIN' = 'ERROR_OPENING_RECYCLE_BIN';

export const SELECT_FOLDER: 'SELECT_FOLDER' = 'SELECT_FOLDER';

export const GET_META_DATA: 'GET_META_DATA' = 'GET_META_DATA';
