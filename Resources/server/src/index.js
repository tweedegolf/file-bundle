...
app.use('/', express.static('Resources/server'));
app.use('/assets', express.static('Resources/server/assets'));
app.use('/media', express.static('Resources/server/media'));
app.use('/browser/locales', express.static('Resources/locales'));
app.use('/filepicker/locales', express.static('Resources/locales'));
